...
#   depends_on       = [data.vsphere_virtual_machine.server2019_template, vsphere_virtual_machine.pfsense]
...
#   depends_on       = [data.vsphere_virtual_machine.server2016_template, vsphere_virtual_machine.pfsense]
#   name             = each.value.name
#   resource_pool_id = data.vsphere_resource_pool.pool.id
#   datastore_id     = data.vsphere_datastore.datastore.id
