...
cd /home/ansible/ansible/ || exit
echo "[+] Current folder $(pwd)"
echo "[+] Current LAB : $LAB"
echo "[+] Current PROVIDER : $PROVIDER"
export ANSIBLE_COMMAND="ansible-playbook -i /home/ansible/ad/$LAB/data/inventory -i /home/ansible/ad/$LAB/providers/$PROVIDER/inventory"
